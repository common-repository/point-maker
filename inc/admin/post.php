			...
			<div id="p_m_modal">
					...
					<div>
						...
						<select id="p_m_edit_color" name="p_m_edit_color" onchange="point_maker_change_color();">
							...
							foreach ($default_settings['type_colors'] as $key => $value) {
								...
								echo '<option value="'.esc_attr( $key ).'"'.selected( esc_attr( $key ), 'apple_green' , false ).' style="background-color:' . esc_attr( $colors['base'] ) . ';color:'. esc_attr(  point_maker_BlackOrWhite($colors['base']) ) .'">' . esc_html( $value ) . '</option>';
							}
				...
				<div class="p_m_flex p_m_ai_c p_m_jc_sb p_m_wrap" style="margin-bottom:16px">
					...
					<div>
						...
						<label id="p_m_select_title_icon" class="p_m_select_icon p_m_flex p_m_jc_c p_m_ai_c" for="p_m_icons_list_open" onclick="point_maker_open_icon_list('p_m_select_title_icon')" style="margin: auto;">
							<?php
							echo esc_attr( str_replace('<svg', '<svg style="width:32px;height:32px;fill:#111;"', esc_attr( point_maker_get_svg_icon( 'info-circle-solid' ) ) ) );
							?>
						</label>
					</div>
				</div>
				<div class="p_m_flex p_m_ai_c p_m_wrap">
					<div style="margin-right:16px">
						<label for="p_m_title_color_background" style="flex: none;"><?php esc_html_e('Color the background','point-maker'); ?></label>
					...
					<div>
						<label for="p_m_title_color_border" style="flex: none;"><?php esc_html_e('Color the border','point-maker'); ?></label>
						<div class="p_m_checkbox">
					...
					<div>
						<div id="p_m_select_list_icon_wrap">
							...
							<label id="p_m_select_list_icon" class="p_m_select_icon p_m_flex p_m_jc_c p_m_ai_c" for="p_m_icons_list_open" onclick="point_maker_open_icon_list('p_m_select_list_icon')" style="margin: auto;">
								<?php
								echo esc_attr( str_replace('<svg', '<svg style="width:32px;height:32px;fill:#111;"', point_maker_get_svg_icon( 'caret-right-solid' ) ) );
								?>
							</label>
						</div>
					</div>
				...
				<div class="p_m_flex p_m_ai_c p_m_wrap">
					<div style="margin-right:16px">
						<label for="p_m_content_color_background" style="flex: none;"><?php esc_html_e('Color the background','point-maker'); ?></label>
						<div class="p_m_checkbox">
					...
					<div>
						<label for="p_m_content_color_border" style="flex: none;"><?php esc_html_e('Color the border','point-maker'); ?></label>
						<div class="p_m_checkbox">
			...
			<div id="p_m_icons_list" class="p_m_absolute">
				<div class="p_m_flex p_m_ai_c p_m_wrap">
					...
					foreach ($default_settings['type_icons'] as $key => $value) {
						echo '<label class="p_m_icons_list_wrap p_m_flex p_m_jc_c p_m_ai_c" data-icon_name="'.esc_attr($key).'" for="p_m_icons_list_open" onclick="point_maker_select_icon(\''.esc_attr($key).'\')">';
						echo esc_attr( str_replace('<svg', '<svg style="width:32px;height:32px;fill:#111;"', esc_attr( point_maker_get_svg_icon( $key ) ) ) );
						echo '</label>';
					}
